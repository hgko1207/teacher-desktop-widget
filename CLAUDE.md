...
### Users
**대상**: 초/중/고등학교 교사 (한국)
**사용 맥락**: 하루 종일 켜놓는 항상-온(always-on) 데스크탑 위젯. 능동 조작보다 **흘낏 훑어보는** 패턴.

### Brand Personality
**3단어**: 차분한 · 전문적인 · 군더더기 없는

### Design Principles

1. **항상-온을 위한 절제** — 위젯은 배경이지 주인공이 아님. 애니메이션·강조 최소화.
2. **정보 계층 우선** — 현재 교시 > 시계 > 날씨·미세먼지 > 나머지. 장식이 정보를 가리면 안 됨.
3. **전문적 일관성** — 카드 스타일·패딩·폰트 크기 전체 통일. 어디서나 예측 가능해야 함.
4. **한국 교육 맥락** — 교시/급식/컴시간 등 국내 교사에게 자연스러운 표현 우선.
5. **데스크탑 네이티브** — 바탕화면과 어우러지는 글래스모피즘. 웹앱 느낌 지양.

### Accessibility 규칙
- 시간표 파스텔 배경에 **흰 글씨 금지** (어두운 텍스트만)
- 소형 텍스트(11px 이하)는 **font-weight 600+** 유지
- 클릭 영역 최소 **32×32px** 확보
