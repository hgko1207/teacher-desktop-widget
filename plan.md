...
#### 8-4. 글자 크기 설정 실제 반영
- **문제**: `fontSize`가 루트 div에만 적용됨. 위젯 내부는 `11px`, `14px` 등 고정 px 사용
- **해결**: CSS 변수 `--base-font` 사용, 위젯 내부에서 `em` 단위 또는 CSS 변수 참조
- 또는 간단하게: 루트에 `zoom` 속성 적용 (small: 0.9, medium: 1, large: 1.1)
