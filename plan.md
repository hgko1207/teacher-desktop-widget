...
### Step 2: D-Day 및 급식 기능 완성 🟡 높음

#### 3-5. D-Day 편집 기능
- **구현**: 클릭 시 D-Day 추가/편집/삭제 모달
- **기능**: 제목 + 날짜 입력, 여러 D-Day 등록, 메인 D-Day 선택
- **저장**: 기존 ddays 스토어 활용 (이미 타입 있음)
- **우선순위**: 🟡 높음

#### 3-6. 급식 메뉴 표시 개선
- **구현**: 나이스 Open API 연동 (Phase 4에서 실제 API, 지금은 수동 입력)
- **기능**: 수동으로 오늘의 메뉴 입력/편집, 칼로리 표시
- **우선순위**: 🟢 보통
