...
export function TitleBar({ onOpenSettings }: TitleBarProps): ReactNode {
  ...
  return (
    <div className="drag-region flex items-center justify-between shrink-0" style={{ height: '36px' }}>
      <div className="no-drag flex items-center gap-2">
        {launchers.map((l) => (
          ...
          >
            ...
            <span className="text-[10px] font-medium" style={{ color: '#64748b' }}>{l.name}</span>
          </button>
        ))}
      </div>
